...
/* поговорим про функции, про обычные, про стрелочные, про способы их создания, а именно: function expression - выражение, function declaration - объявление, как передавать параметры и аргументы функции, есть ли разница между ними  */
...
// Разница заключается в том, что когда мы создаем переменную через function declaration мы можем вызвать ее даже до ее создания, а когда создаем через function expression - она ведет себя как переменная, и мы не можем ее вызвать до ее создания 
